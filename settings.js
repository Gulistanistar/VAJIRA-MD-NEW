...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zYN3zRiL#Sb5hZjAbDFMLyqM-oCINZ_S5ngwsTm59AISArnK3sIo' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '8536': process.env.MAX_SIZE,/*add this in megabytes*/    
